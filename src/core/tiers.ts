...
export const TIERS: Tier[] = [
  ...
  { id: 'SMALL',  label: 'Küçük',    emoji: '🐠', minNotional: 100,      color: '#8B9BBB' },
  { id: 'MEDIUM', label: 'Orta',     emoji: '🐡', minNotional: 1_000,    color: '#A78BFA' },
  { id: 'LARGE',  label: 'Büyük',    emoji: '🦈', minNotional: 10_000,   color: '#22D3EE' },
  { id: 'WHALE',  label: 'Balina',   emoji: '🐋', minNotional: 100_000,  color: '#34D399' },
